...
\lstinline!B()! becomes \lstinline!return y + 3 + 2;!, allowing \textit{Constant
Folding} (CF)~\cite[Ch. 8.5]{DragonBook} to replace \lstinline!3+2! with
\lstinline!5!.
...
\lstinline!C()! and \lstinline!D()!, when exemplifying  duplication.}
	\label{lst:code-dup}
\end{centering}
