...
Subexpression Elimination}\footnote{\label{Ch_8.5_DragonBook} Chapter 8.5
\textit{``Optimization of Basic Blocks''}\cite{DragonBook}.} (CSE) and
\textit{Dead Code Elimination}\footnotemark[\ref{Ch_8.5_DragonBook}] (DCE).
...
\textit{Constant Folding}\cite{DragonBook} (CF) to replace
