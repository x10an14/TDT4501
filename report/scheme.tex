...
Our inliner, written in C++, is integrated into \unsure{Ask Nico for Jive
reference.}Jive. This section details the actions of the inliner, and the
...
While there are better ways~\cite{BasMscThesis} to choose loop breakers more
...
\todo[inline]{Fix ``statement count'' text in below Figure (should be ``node
count'')}
