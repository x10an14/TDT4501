...
\usepackage[usenames,dvipsnames]{xcolor}	%For the SkyBlue background color for lstlistings
...
\usepackage{parcolumns}	%For spreading content over multiple coloumns in single-coloumn document
