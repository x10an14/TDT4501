...
\todo{Cite HiPEAC paper}Bahmann et. al detail algorithms for how any CFG can be
...
$\gamma$ node has two sets of inputs: the predicate, and the \todo{This term is
wrong, check up on this.}variables the predicate depend upon. The outputs are
\todo{same as previous todo.}X, representing the datadependency of the RVSDG.
...
\todo[inline]{Need to remember proper term for this subsubsection.}
