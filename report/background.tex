...
\unsure[inline]{Confirm that the following is true for any complex node with
multiple subregions}
...
The internal inputs of a $\phi$-region \unsure{Nico crossed out ``receive the
function invocation links'', but what he wrote above is illegible. Ask Nico for
clarification.} receive the function invocation links from the $\lambda$-nodes
